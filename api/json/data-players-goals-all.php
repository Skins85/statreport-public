<?php
    ...
    $stmt = $conn->prepare(
        "SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_1_scorer AS scorer_id, season, drfc_goal_1_minute AS goal_time
        from match_scorers
        ...
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_2_scorer, season, drfc_goal_2_minute
        from match_scorers
        ...
        AND season != '$season_exclude'
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_3_scorer, season, drfc_goal_3_minute
        from match_scorers
        ...
        AND season != '$season_exclude'
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_4_scorer, season, drfc_goal_4_minute
        from match_scorers
        ...
        AND season != '$season_exclude'
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_5_scorer, season, drfc_goal_5_minute
        from match_scorers
        ...
        AND season != '$season_exclude'
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_6_scorer, season, drfc_goal_6_minute
        from match_scorers
        ...
        AND season != '$season_exclude'
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_7_scorer, season, drfc_goal_7_minute
        from match_scorers
        ...
        AND season != '$season_exclude'
        union all
      SELECT date, first_name, surname, season, competition, match_scorers.match_id, s_drfc_goal_8_scorer, season, drfc_goal_8_minute
        from match_scorers
